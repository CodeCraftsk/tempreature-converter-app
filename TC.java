...
public class TC extends JFrame {
    ...
    class Handler implements ActionListener {
        ...
        private void convertTemperature() {
            String x, y;
            x = tc1.getSelectedItem().toString();
            y = tc2.getSelectedItem().toString();

            try {
                double inputTemp = Double.parseDouble(t1.getText());
                double convertedTemp = 0;

                // Conversion logic
                if (x.equals("Celsius") && y.equals("Fahrenheit")) {
                    convertedTemp = (inputTemp * 9 / 5) + 32;
                } else if (x.equals("Celsius") && y.equals("Kelvin")) {
                    convertedTemp = inputTemp + 273.15;
                } else if (x.equals("Fahrenheit") && y.equals("Celsius")) {
                    convertedTemp = (inputTemp - 32) * 5 / 9;
                } else if (x.equals("Fahrenheit") && y.equals("Kelvin")) {
                    convertedTemp = (inputTemp - 32) * 5 / 9 + 273.15;
                } else if (x.equals("Kelvin") && y.equals("Celsius")) {
                    convertedTemp = inputTemp - 273.15;
                } else if (x.equals("Kelvin") && y.equals("Fahrenheit")) {
                    convertedTemp = (inputTemp - 273.15) * 9 / 5 + 32;
                } else {
                    // Handle other conversion cases similarly
                }

                t2.setText(String.format("%.2f", convertedTemp));
